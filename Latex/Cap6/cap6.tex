...
\begin{figure}[htb]
\centering
\includegraphics[width=0.75\textwidth]{../Cap6/limit_observed_lnulnu_log}
...
the former sets a powerful limit at low mass ($<$ 1 TeV), the other at  high mass
%\footnote{To correctly compare Fig.~\ref{fig:lim_OFSF_comb} with  Fig~\ref{limit_observed_lnuqq_VBF0_log-1}, the limits for the  fully leptonic channel must be multiplied by a factor of $\sim$10 to take in account the BR of the W's in $ 2\ell 2\nu$.\\}. 
...
The final statistical analysis is a template analysis 
performed on the ``improved transverse mass'' ($m_T^I$), a dedicate variable introduced for this specific analysis. 
