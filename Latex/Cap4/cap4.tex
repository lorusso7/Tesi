...
I have contributed in the evaluation of the best b-tagging working point for Standard Model Higgs boson analysis with 2015 data~\cite{CMS-PAS-HIG-16-021} and marginally for the same analysis using 2016 data~\cite{CMS-PAS-HIG-16-042}, Tab.~\ref{btt}.}
...
charged tracks (GSF tracks).  Pixel hits provide the best track
...
can introduce a bias in the $\vec{p_T}^{\: miss}$. A correction is applied by propagating
